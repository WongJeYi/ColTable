    ...
    public:
        ...
        */
        ...
        StringView get_string_view() const {
            if (!valueBuffer || !offsetBuffer) return {nullptr, nullptr, 0, 0};
        ...
        View<T> get(int64_t index)const {
            if (!valueBuffer||index >= length) return {nullptr, 0};
            ...
            if (offsetBuffer && !children.empty()) {
                ...
                if (!dataChild || !dataChild->valueBuffer) return {nullptr, 0};
